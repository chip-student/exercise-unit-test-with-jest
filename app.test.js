...
test("One dollar should be 127.9 Japan YEN", function(){
    ...
    // if 1 dollar are 127.9 Japan YEN, then 3.5 dollar should be (3.5 * 127.9 )
...
test("One YEN should be 0.8 England Pound", function(){
    ...
    // if 1 YEN are 0.8 England Pound, then 3.5 yen should be (3.5 * 0.8)
